...
from src.agents.d3qn.replay_buffer import ReplayBuffer
...
class D3QNAgent:
    def __init__(self, state_size, action_size, device, config):
        ...
        self.policy_net = DuelingQNetwork(
            state_size, action_size, hidden_size, num_hidden_layers
        ).to(device)
    ...
    def _learn(self):
        ...
        # Double DQN target: action selection from policy net, evaluation from target net.
